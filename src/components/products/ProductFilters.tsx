...
export default async function ProductFilters({ q }: { q: ProductQuery }) {
  ...
  return (
    <aside className="w-full shrink-0">
      <div className="border border-black/10 bg-white p-4 lg:sticky lg:top-28">
        <h2 className="mb-4 border-b border-black/10 pb-2 text-xl font-semibold">{t("title")}</h2>
        ...
        <form method="get" className="flex flex-col gap-4">
          ...
          <button type="submit" className="cta mt-4 cursor-pointer px-4 text-base font-medium text-white">
            {t("apply")}
          </button>
